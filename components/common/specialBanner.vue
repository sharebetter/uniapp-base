<template>
  <div class="banner-container">
    <swiper :style="{width: '686rpx', height: '860rpx'}" 
          ...
          <view class="slide-item-list" 
            :style="{
			  ...
			  <view class="item-list-top">
				  <view class="title xz-ellipsis-3">{{item.title}}</view>
				  <image class="icon-light" src="../../static/project/icon-light.png" mode=""></image>
			  </view>
			  <view class="item-list-content-wrap">
				  <scroll-view :scroll-y="true" class="item-list-content">
					<rich-text :nodes="item.articleBody"></rich-text>
				  </scroll-view>
			  </view>
		  </view>
        </view>
